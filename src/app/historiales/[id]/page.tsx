                    ...
                    filteredHistories.map((record) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="text-sm text-gray-900 max-w-xs truncate">{record.motivoConsulta || 'Sin motivo'}</div>
                        </td>
                        <td className="px-6 py-4">
                          <div className="text-sm text-gray-900 max-w-xs truncate">{record.diagnostico || 'Sin diagnóstico'}</div>
                        </td>
